...
describe Turn do
  ...
  deck4 = Deck.new([card12, card3, card14, card15])

  player1 = Player.new('Megan', deck1)
  player2 = Player.new('Aurora', deck2)
  player3 = Player.new('Jean', deck3)
  player4 = Player.new('Bobby', deck4)
  ...
  it 'return type :mutually_assured_destruction and behaviors' do
